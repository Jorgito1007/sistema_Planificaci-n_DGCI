...
notaCell.value =
  "NOTA: Este anexo se imprimirá directamente desde la Matriz de Evaluación de Control Interno a los Sistemas de Administración.";
...
/>
        ...
        <div className="mt-3 text-[15px]">
          ...
          Evaluación de Control Interno a los Sistemas de Administración.
        </div>
