...
export default function MatrizInvProyectPage() {
  const SUBMODULE_KEY = "m_Invproyec";
      ...
      <div className="overflow-hidden rounded-2xl border bg-[#e7c0a1] shadow-sm">
        ...
        <div className="px-4 py-5">
          <p className="text-sm font-medium leading-7 text-justify">
           Las inversiones físicas u obras de infraestructura ejecutadas,sean nuevas o ampliaciones
           de las ya existentes,constituyen Inversiones en programas y proyectos que se regirán
           por las normas de esta sección y demás disposiciones aplicables. También se consideran proyectos,
           aquellos conducentes a desarrollar obras no físicas o en las cuales no predominan un resultado físico,
           sino la transferencia de conocimientos.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border bg-white shadow-sm overflow-hidden">
        <div className="border-b bg-slate-100 px-4 py-3">
          <h3 className="text-base font-semibold text-slate-800">
            Matriz de Evaluación - Inversiones en Programas y proyectos
          </h3>
        </div>
