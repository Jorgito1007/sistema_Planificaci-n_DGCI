...
export default function MatrizTICPage() {
  const SUBMODULE_KEY = "m_TIC";
      ...
      <div className="overflow-hidden rounded-2xl border bg-[#e7c0a1] shadow-sm">
        ...
        <div className="px-4 py-5">
          <p className="text-sm font-medium leading-7 text-justify">
           Es responsabilidad de la máxima autoridad y la administración asegurar que la 
           tecnología de información esté organizada en su forma y contenido, conforme a las necesidades
           de información de la entidad de acuerdo a los objetivos de la misma.
           La planeación y organización de la tecnología de información debe estar ajustada a los
           objetivos de la entidad. y proveer las bases para las adquisiciones, implementaciones, desarrollo y soporte a brindar,
           así como, la implementación del monitoreo y evaluación correspondiente a los servicios tecnológicos, asegurando
           con ello se afecten mínimamente las operaciones de la Entidad.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border bg-white shadow-sm overflow-hidden">
        <div className="border-b bg-slate-100 px-4 py-3">
          <h3 className="text-base font-semibold text-slate-800">
            Matriz de Evaluación - Tecnología de la Infomación
          </h3>
        </div>
