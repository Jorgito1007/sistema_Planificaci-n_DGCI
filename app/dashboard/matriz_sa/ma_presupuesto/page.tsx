...
export default function MatrizpresupuestoPage() {
  const SUBMODULE_KEY = "m_presupuesto";
      ...
      <div className="overflow-hidden rounded-2xl border bg-[#e7c0a1] shadow-sm">
        ...
        <div className="px-4 py-5">
          <p className="text-sm font-medium leading-7 text-justify">
            Se establecerán y mantendrán controles necesarios en los sistemas de administración
            financiera y presupuestaria, a fin de asegurar el cumplimiento en todas las fases del 
            Presupuesto, de acuerdo con la ley que regula la materia. 
          </p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border bg-white shadow-sm overflow-hidden">
        <div className="border-b bg-slate-100 px-4 py-3">
          <h3 className="text-base font-semibold text-slate-800">
            Matriz de Evaluación - Presupuesto
          </h3>
        </div>
