...
export default function MatrizRecursosHumanosPage() {
  const SUBMODULE_KEY = "m_talento_humano";
      ...
      <div className="overflow-hidden rounded-2xl border bg-[#e7c0a1] shadow-sm">
        ...
        <div className="px-4 py-5">
          <p className="text-sm font-medium leading-7 text-justify">
            Las actividades de control en el Sistema de Administración se deben
            realizar aplicando criterios legales, técnicos y metodológicos para
            toda Entidad Pública, estas tienen que definirse y ajustarse en
            función de sus objetivos, para alcanzar eficiencia, economía y
      ...
      <div className="rounded-2xl border bg-white shadow-sm overflow-hidden">
        <div className="border-b bg-slate-100 px-4 py-3">
          <h3 className="text-base font-semibold text-slate-800">
            Matriz de Evaluación - Administración de los Recursos Humanos
          </h3>
        </div>
