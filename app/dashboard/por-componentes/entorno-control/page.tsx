...
const PRINCIPIOS: Principio[] = [
  { id: 1, titulo: "Principio 1", color: "bg-blue-600", rowColor: "bg-[#cfe2f3]" },
  { id: 2, titulo: "Principio 2", color: "bg-green-600", rowColor: "bg-[#d9ead3]" },
  { id: 3, titulo: "Principio 3", color: "bg-yellow-500", rowColor: "bg-[#fff2cc]" },
  { id: 4, titulo: "Principio 4", color: "bg-purple-600", rowColor: "bg-[#e4d5f7]" },
  { id: 5, titulo: "Principio 5", color: "bg-red-600", rowColor: "bg-[#f4cccc]" },
];
...
async function cargarCargos() {
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="rounded-2xl border bg-white p-6 shadow-sm">
        <h1 className="text-2xl font-bold text-slate-800">Componente 1</h1>
        <h2 className="mt-2 text-lg font-semibold text-slate-700">ENTORNO DE CONTROL</h2>
        <p className="mt-4 text-sm leading-6 text-slate-600 text-justify">
          El entorno de control apropiado persigue establecer y mantener un ambiente
          mediante el cual, se logre una actitud positiva de respaldo de las personas
          hacia el Control Interno, crea conciencia en los Servidores Públicos de todos
          los niveles, sobre la relevancia de la integridad y los valores éticos, la
          necesidad de una estructura organizativa alineada en correspondencia a los
          objetivos de la Entidad, cultura de enfoque a riesgos y atención a los mismos,
          la adecuada asignación de responsabilidades para el logro de los objetivos de
          la Administración.
        </p>
      </div>
  ...
  <th rowSpan={3} className="border px-2 py-2 min-w-[180px] text-center align-middle">
    CARGO
  </th>

  <th colSpan={3} className="border px-2 py-2">Presente</th>

  <th rowSpan={3} className="border px-2 py-2 min-w-[90px]">
    Está presente
  </th>

  <th colSpan={2} className="border px-2 py-2">Funcionando</th>
